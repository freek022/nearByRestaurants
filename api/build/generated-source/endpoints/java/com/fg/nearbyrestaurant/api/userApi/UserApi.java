 ...
 * on 2017-03-09 at 00:58:09 UTC 
 * Modify at your own risk.
 */

package com.fg.nearbyrestaurant.api.userApi;
...
public class UserApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Get extends UserApiRequest<com.fg.nearbyrestaurant.api.userApi.model.User> {
    ...
    protected Get(java.lang.String userName) {
      super(UserApi.this, "GET", REST_PATH, null, com.fg.nearbyrestaurant.api.userApi.model.User.class);
   ...
   *
   * @param content the {@link com.fg.nearbyrestaurant.api.userApi.model.User}
   * @return the request
   */
  public Insert insert(com.fg.nearbyrestaurant.api.userApi.model.User content) throws java.io.IOException {
    Insert result = new Insert(content);
    initialize(result);
    return result;
  }

  public class Insert extends UserApiRequest<com.fg.nearbyrestaurant.api.userApi.model.User> {
     ...
     * @since 1.13
     */
    protected Insert(com.fg.nearbyrestaurant.api.userApi.model.User content) {
      super(UserApi.this, "POST", REST_PATH, content, com.fg.nearbyrestaurant.api.userApi.model.User.class);
    }
  ...
  public class List extends UserApiRequest<com.fg.nearbyrestaurant.api.userApi.model.CollectionResponseUser> {
     ...
     */
    protected List() {
      super(UserApi.this, "GET", REST_PATH, null, com.fg.nearbyrestaurant.api.userApi.model.CollectionResponseUser.class);
    }
   ...
   * @return the request
   */
  public Patch patch(java.lang.String userName, com.fg.nearbyrestaurant.api.userApi.model.User content) throws java.io.IOException {
    Patch result = new Patch(userName, content);
    initialize(result);
    return result;
  }

  public class Patch extends UserApiRequest<com.fg.nearbyrestaurant.api.userApi.model.User> {
     ...
     * @since 1.13
     */
    protected Patch(java.lang.String userName, com.fg.nearbyrestaurant.api.userApi.model.User content) {
      super(UserApi.this, "PATCH", REST_PATH, content, com.fg.nearbyrestaurant.api.userApi.model.User.class);
      this.userName = com.google.api.client.util.Preconditions.checkNotNull(userName, "Required parameter userName must be specified.");
    }
   ...
   * @return the request
   */
  public Update update(java.lang.String userName, com.fg.nearbyrestaurant.api.userApi.model.User content) throws java.io.IOException {
    Update result = new Update(userName, content);
    initialize(result);
    return result;
  }

  public class Update extends UserApiRequest<com.fg.nearbyrestaurant.api.userApi.model.User> {
     ...
     * @since 1.13
     */
    protected Update(java.lang.String userName, com.fg.nearbyrestaurant.api.userApi.model.User content) {
      super(UserApi.this, "PUT", REST_PATH, content, com.fg.nearbyrestaurant.api.userApi.model.User.class);
      this.userName = com.google.api.client.util.Preconditions.checkNotNull(userName, "Required parameter userName must be specified.");
    }
